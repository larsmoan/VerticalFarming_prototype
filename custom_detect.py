...
if __name__ == '__main__':
    ...
    custom_detect(str(current_path) + '/src/picker/src/picker/yolov7/yolov7_multiclass_best_weights.pt', str(current_path) + '/src/picker/src/picker/inference', 0.2, 0.45, True, False, True)
